...
import { calculateBurj, type BurjCalculation } from '../constants/buruj';
import {
    calculatePlanetaryHour,
    getPlanetByHour,
    type PlanetarySignature
...
export const ruhHadad = (total: number): RuhHadad => {
  ...
  const element = hadathToElement(hadathRemainder(r));
  return {
    value: r,
    element,
    quality: 'balanced',
    description: `Rūḥ element: ${element}, value ${r}`
  };
};
...
export const withMother = (total: number, motherTotal: number): UmHadad => {
  ...
  return {
    total: t,
    motherElement: hadathToElement(hadathRemainder(t)),
    influence: `Combined total: ${t}`
  };
};
...
export const nearestSacred = (n: number): SacredResonance => {
  ...
  return {
    nearest,
    resonance: delta,
    description: isExact ? `Exact sacred number: ${nearest}` : `Near sacred ${nearest} (Δ${delta}), factors: ${factors.join(',') || 'none'}`
  };
};
...
export const ASMA_LIST = [
  ...
  { ar: 'يَا عَزِيز', transliteration: 'Yā ʿAzīz', en: 'The Mighty', abjad: 104, element: 'Fire' as ElementType, counts: [94, 104] },
  { ar: 'يَا جَبَّار', transliteration: 'Yā Jabbār', en: 'The Compeller', abjad: 206, element: 'Fire' as ElementType, counts: [206, 300] },
  { ar: 'يَا قَهَّار', transliteration: 'Yā Qahhār', en: 'The Subduer', abjad: 306, element: 'Fire' as ElementType, counts: [306, 500] },
  ...
  { ar: 'يَا رَحْمَان', transliteration: 'Yā Raḥmān', en: 'The Compassionate', abjad: 298, element: 'Water' as ElementType, counts: [298, 500] },
  { ar: 'يَا غَفُور', transliteration: 'Yā Ghafūr', en: 'The Forgiving', abjad: 1286, element: 'Water' as ElementType, counts: [100, 1286] },
  { ar: 'يَا كَرِيم', transliteration: 'Yā Karīm', en: 'The Generous', abjad: 270, element: 'Water' as ElementType, counts: [270, 500] },
  ...
  { ar: 'يَا خَبِير', transliteration: 'Yā Khabīr', en: 'The Aware', abjad: 812, element: 'Air' as ElementType, counts: [812, 1000] },
  { ar: 'يَا سَمِيع', transliteration: 'Yā Samīʿ', en: 'The All-Hearing', abjad: 180, element: 'Air' as ElementType, counts: [180, 300] },
  { ar: 'يَا بَصِير', transliteration: 'Yā Baṣīr', en: 'The All-Seeing', abjad: 302, element: 'Air' as ElementType, counts: [302, 500] },
  ...
  { ar: 'يَا مُقِيت', transliteration: 'Yā Muqīt', en: 'The Sustainer', abjad: 550, element: 'Earth' as ElementType, counts: [550, 1000] },
  { ar: 'يَا حَفِيظ', transliteration: 'Yā Ḥafīẓ', en: 'The Guardian', abjad: 998, element: 'Earth' as ElementType, counts: [998, 1000] },
  { ar: 'يَا مُحِيط', transliteration: 'Yā Muḥīṭ', en: 'The Encompasser', abjad: 458, element: 'Earth' as ElementType, counts: [458, 500] },
  
  // Additional balanced names for better coverage
  { ar: 'يَا وَاحِد', transliteration: 'Yā Wāḥid', en: 'The One', abjad: 19, element: 'Fire' as ElementType, counts: [19, 99] },
  { ar: 'يَا أَحَد', transliteration: 'Yā Aḥad', en: 'The Unique', abjad: 13, element: 'Fire' as ElementType, counts: [13, 99] },
  { ar: 'يَا صَمَد', transliteration: 'Yā Ṣamad', en: 'The Eternal', abjad: 134, element: 'Earth' as ElementType, counts: [134, 300] },
  { ar: 'يَا قَادِر', transliteration: 'Yā Qādir', en: 'The Capable', abjad: 305, element: 'Fire' as ElementType, counts: [305, 500] },
  { ar: 'يَا مُقْتَدِر', transliteration: 'Yā Muqtadir', en: 'The Powerful', abjad: 744, element: 'Fire' as ElementType, counts: [744, 1000] },
  { ar: 'يَا رَقِيب', transliteration: 'Yā Raqīb', en: 'The Watchful', abjad: 312, element: 'Air' as ElementType, counts: [312, 500] },
  { ar: 'يَا مُجِيب', transliteration: 'Yā Mujīb', en: 'The Responder', abjad: 55, element: 'Water' as ElementType, counts: [55, 99] },
  { ar: 'يَا وَاسِع', transliteration: 'Yā Wāsiʿ', en: 'The All-Encompassing', abjad: 137, element: 'Air' as ElementType, counts: [137, 300] },
];
 ...
 */
export { calculateBurj, type BurjCalculation };
...
export function getPlanetarySignatureFromTotal(total: number): PlanetarySignature {
  // Use current date/time for planetary hour calculation
  const hourNumber = calculatePlanetaryHour(new Date());
