      ...
      >
        ...
        <Tab.Screen name={t('istikhara.results.tabs.personality') || 'Personality'}>
          {() => (
            <PremiumTabWrapper
              ...
              title={t('istikhara.results.tabs.personality') || 'Personality Insights'}
              description={language === 'fr' 
                ? 'Découvrez vos traits de personnalité profonds' 
                : 'Discover your deep personality traits'}
              icon="🧠"
            >
        ...
        <Tab.Screen name={t('istikhara.results.tabs.career') || 'Career'}>
          {() => (
            <PremiumTabWrapper
              ...
              title={t('istikhara.results.tabs.career') || 'Career Guidance'}
              description={language === 'fr' 
                ? 'Orientations professionnelles basées sur votre profil' 
                : 'Career direction based on your spiritual profile'}
              icon="💼"
            >
        ...
        <Tab.Screen name={t('istikhara.results.tabs.blessedDay') || 'Blessed Day'}>
          {() => (
            <PremiumTabWrapper
              ...
              title={t('istikhara.results.tabs.blessedDay') || 'Your Blessed Day'}
              description={language === 'fr' 
                ? 'Découvrez votre jour le plus favorable' 
                : 'Discover your most favorable day'}
              icon="📅"
            >
        ...
        <Tab.Screen name={t('istikhara.results.tabs.spiritual') || 'Spiritual'}>
          {() => (
            <PremiumTabWrapper
              featureId="spiritualGuidance"
              title={t('istikhara.results.tabs.spiritual') || 'Spiritual Practice'}
              description={language === 'fr' 
