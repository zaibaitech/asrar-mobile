/**
 * Quran Metadata - All 114 Surahs with Ayah Counts
 * Used for Qur'anic Resonance calculation
 */

export const QURAN_META: Record<number, { name: string; nameAr: string; totalAyahs: number }> = {
